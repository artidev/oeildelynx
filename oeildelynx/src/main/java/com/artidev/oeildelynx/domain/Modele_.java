...
public abstract class Modele_ {

    // Raw attributes
    public static volatile SingularAttribute<Modele, Integer> id;
    public static volatile SingularAttribute<Modele, String> nomModele;

    // Many to one
    public static volatile SingularAttribute<Modele, Marque> codeMarque;
}
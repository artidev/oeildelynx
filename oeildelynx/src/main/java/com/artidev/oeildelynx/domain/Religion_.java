...
public abstract class Religion_ {

    // Raw attributes
    public static volatile SingularAttribute<Religion, Integer> id;
    public static volatile SingularAttribute<Religion, String> libelleReligion;

    // Many to one
    public static volatile SingularAttribute<Religion, Race> codeRace;
}